...
public class Boat extends Fragment
{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        banana_req.setText(pref.getString("Boat" + "Banana", null));
        gold_req.setText(pref.getString("Boat" + "Gold", null));
        bamboo_req.setText(pref.getString("Boat" + "Bamboo", null));
        wood_req.setText(pref.getString("Boat" + "Timber", null));
        coconut_req.setText(pref.getString("Boat" + "Coconut", null));


        if ((pref.getString("Boat" + "Banana", null)) != null)
            banana_r = Integer.parseInt((pref.getString("Boat" + "Banana", null)).toString());
        if ((pref.getString("Boat" + "Gold", null)) != null)
            gold_r = Integer.parseInt(pref.getString("Boat" + "Gold", null).toString());
        if ((pref.getString("Boat" + "Bamboo", null)) != null)
            bamboo_r = Integer.parseInt(pref.getString("Boat" + "Bamboo", null).toString());
        if ((pref.getString("Boat" + "Timber", null)) != null)
            wood_r = Integer.parseInt(pref.getString("Boat" + "Timber", null).toString());
        if ((pref.getString("Boat" + "Coconut", null)) != null)
            coconut_r = Integer.parseInt(pref.getString("Boat" + "Coconut", null).toString());
        ...
        boat_image.setImageResource(R.drawable.boat);
