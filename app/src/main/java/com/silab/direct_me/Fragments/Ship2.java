package com.silab.direct_me.Fragments;
...
import com.silab.direct_me.Fragments.DFragment;
import com.silab.direct_me.Fragments.Raft;
import com.silab.direct_me.R;
import com.silab.direct_me.checkPurchase;

import static android.content.Context.MODE_PRIVATE;

public class Ship2 extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        banana_req.setText(pref.getString("Ship2" + "Banana", null));
        gold_req.setText(pref.getString("Ship2" + "Gold", null));
        bamboo_req.setText(pref.getString("Ship2" + "Bamboo", null));
        wood_req.setText(pref.getString("Ship2" + "Timber", null));
        coconut_req.setText(pref.getString("Ship2" + "Coconut", null));
        ...
        boat_speed.setText(pref.getString("Ship2"+"Speed",null));
